...
import ir.bank.qh.productbuilder.commonrules.repository.ProductRateTierRepository;
...
/**
 * Service for ProductRateTier. Business-rule checks equivalent to the
...
public class ProductRateTierService extends AbstractCrudService<ProductRateTier> {
    ...
    @Override
    protected JpaRepository<ProductRateTier, Long> repository() {
        return repository;
    }

    @Override
    protected String entityName() {
        return "ProductRateTier";
    }
}
