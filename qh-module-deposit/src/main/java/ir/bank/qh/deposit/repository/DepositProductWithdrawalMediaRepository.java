...
/**
 * Spring Data repository for DepositProductWithdrawalMedia (deposit_product_withdrawal_media).
 * Add derived-query methods here as new lookups are needed
 * (e.g. findByProductVersionId, findByRecordStatusCode...).
 */
@Repository
public interface DepositProductWithdrawalMediaRepository extends JpaRepository<DepositProductWithdrawalMedia, Long> {
}
