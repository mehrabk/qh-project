...
/**
 * Spring Data repository for DepositProductClosureSettlementRule (deposit_product_closure_settlement_rule).
 * Add derived-query methods here as new lookups are needed
 * (e.g. findByProductVersionId, findByRecordStatusCode...).
 */
@Repository
public interface DepositProductClosureSettlementRuleRepository extends JpaRepository<DepositProductClosureSettlementRule, Long> {
}
