...
import ir.bank.qh.party.core.entity.OrganizationEntity;
import ir.bank.qh.party.core.service.OrganizationEntityService;
...
/**
 * REST endpoints for OrganizationEntity. Base path: /api/v1/party/organizations
 */
@RestController
