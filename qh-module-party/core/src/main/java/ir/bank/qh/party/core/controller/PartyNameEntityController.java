...
import ir.bank.qh.party.core.entity.PartyNameEntity;
import ir.bank.qh.party.core.service.PartyNameEntityService;
...
/**
 * REST endpoints for PartyNameEntity. Base path: /api/v1/party/party-names
 */
@RestController
