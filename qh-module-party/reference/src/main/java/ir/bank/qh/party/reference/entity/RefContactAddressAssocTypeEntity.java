...
/**
 * نحوه ارتباط یک راه تماس با یک نشانی.
 * Maps to table REF_CONTACT_ADDRESS_ASSOC_TYPE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_CONTACT_ADDRESS_ASSOC_TYPE")
@Getter
@Setter
public class RefContactAddressAssocTypeEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "ASSOCIATION_TYPE_CODE", length = 50)
