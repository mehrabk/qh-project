...
/**
 * کاربرد یا هدف راه تماس.
 * Maps to table REF_CONTACT_PURPOSE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_CONTACT_PURPOSE")
@Getter
@Setter
public class RefContactPurposeEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "CONTACT_PURPOSE_CODE", length = 50)
