...
/**
 * انواع راه تماس صندوقی Party.
 * Maps to table REF_CONTACT_TYPE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_CONTACT_TYPE")
@Getter
@Setter
public class RefContactTypeEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "CONTACT_TYPE_CODE", length = 50)
