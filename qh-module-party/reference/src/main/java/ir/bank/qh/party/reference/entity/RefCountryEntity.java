...
/**
 * کشورها برای محل تولد، نشانی و ثبت اشخاص حقوقی.
 * Maps to table REF_COUNTRY.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_COUNTRY")
@Getter
@Setter
public class RefCountryEntity extends BaseEntity {
