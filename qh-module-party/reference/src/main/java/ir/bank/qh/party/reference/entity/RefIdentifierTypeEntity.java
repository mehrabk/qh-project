...
/**
 * انواع شناسه‌های هویتی اشخاص حقیقی و حقوقی.
 * Maps to table REF_IDENTIFIER_TYPE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_IDENTIFIER_TYPE")
@Getter
@Setter
public class RefIdentifierTypeEntity extends BaseEntity {
