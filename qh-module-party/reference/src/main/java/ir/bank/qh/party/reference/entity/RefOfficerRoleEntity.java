...
/**
 * سمت فرد در شخص حقوقی در همان صندوق.
 * Maps to table REF_OFFICER_ROLE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_OFFICER_ROLE")
@Getter
@Setter
public class RefOfficerRoleEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "OFFICER_ROLE_CODE", length = 50)
