...
/**
 * وضعیت فعالیت سازمان یا شرکت.
 * Maps to table REF_ORG_ACTIVITY_STATUS.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_ORG_ACTIVITY_STATUS")
@Getter
@Setter
public class RefOrgActivityStatusEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "ACTIVITY_STATUS_CODE", length = 50)
