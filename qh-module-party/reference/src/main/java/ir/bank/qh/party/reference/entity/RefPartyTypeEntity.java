...
/**
 * انواع هویت Party در هسته مرکزی.
 * Maps to table REF_PARTY_TYPE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_PARTY_TYPE")
@Getter
@Setter
public class RefPartyTypeEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "PARTY_TYPE_CODE", length = 50)
