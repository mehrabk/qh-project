...
/**
 * نقش‌هایی که Party در یک صندوق می‌تواند داشته باشد.
 * Maps to table REF_ROLE_TYPE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_ROLE_TYPE")
@Getter
@Setter
public class RefRoleTypeEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "ROLE_TYPE_CODE", length = 50)
