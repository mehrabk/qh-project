...
/**
 * قاعده معتبر بودن امضا.
 * Maps to table REF_SIGNING_RULE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_SIGNING_RULE")
@Getter
@Setter
public class RefSigningRuleEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "SIGNING_RULE_CODE", length = 50)
