...
/**
 * وضعیت عمومی رکوردهای زمان‌مند.
 * Maps to table REF_WORKFLOW_STATUS.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_WORKFLOW_STATUS")
@Getter
@Setter
public class RefWorkflowStatusEntity extends BaseEntity {
