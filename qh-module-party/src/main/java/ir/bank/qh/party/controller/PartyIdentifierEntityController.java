...
/**
 * REST endpoints for PartyIdentifierEntity. Every method is written out explicitly here
 * (no AbstractCrudController base), delegating to PartyIdentifierEntityService.
 * Base path: /api/v1/party/party-identifiers
 */
@RestController
