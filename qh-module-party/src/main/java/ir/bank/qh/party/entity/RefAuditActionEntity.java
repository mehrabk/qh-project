...
/**
 * نوع عملیاتی که رویداد Audit برای آن ثبت می‌شود.
 * Maps to table REF_AUDIT_ACTION.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_AUDIT_ACTION")
@Getter
@Setter
public class RefAuditActionEntity extends BaseEntity {
