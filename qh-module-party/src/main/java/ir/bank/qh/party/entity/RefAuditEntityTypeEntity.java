...
/**
 * فهرست موجودیت‌های Party/Customer که تغییر آنها ممیزی می‌شود.
 * Maps to table REF_AUDIT_ENTITY_TYPE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_AUDIT_ENTITY_TYPE")
@Getter
@Setter
public class RefAuditEntityTypeEntity extends BaseEntity {
    ...
    @JoinColumn(name = "DEFAULT_SCOPE_CODE", referencedColumnName = "AUDIT_SCOPE_CODE", nullable = false,
            foreignKey = @ForeignKey(name = "REF_AUDIT_ENTITY_TYP_FK_DEFAUL"))
    private RefAuditScopeEntity defaultScope;
