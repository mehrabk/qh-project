...
/**
 * نوع نمایش و مقایسه مقدار تغییر یافته.
 * Maps to table REF_AUDIT_VALUE_TYPE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_AUDIT_VALUE_TYPE")
@Getter
@Setter
public class RefAuditValueTypeEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "VALUE_TYPE_CODE", length = 50)
