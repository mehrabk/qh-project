...
/**
 * مبنای قانونی یا قراردادی اختیار نقش.
 * Maps to table REF_AUTHORITY_BASIS.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_AUTHORITY_BASIS")
@Getter
@Setter
public class RefAuthorityBasisEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "AUTHORITY_BASIS_CODE", length = 50)
