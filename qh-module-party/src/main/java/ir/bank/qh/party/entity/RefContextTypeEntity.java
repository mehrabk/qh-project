...
/**
 * زمینه‌ای که نقش Party در آن اعمال می‌شود.
 * Maps to table REF_CONTEXT_TYPE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_CONTEXT_TYPE")
@Getter
@Setter
public class RefContextTypeEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "CONTEXT_TYPE_CODE", length = 50)
