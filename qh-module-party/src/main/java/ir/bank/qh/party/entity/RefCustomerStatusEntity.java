...
/**
 * وضعیت رابطه مشتری با صندوق.
 * Maps to table REF_CUSTOMER_STATUS.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_CUSTOMER_STATUS")
@Getter
@Setter
public class RefCustomerStatusEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "CUSTOMER_STATUS_CODE", length = 50)
