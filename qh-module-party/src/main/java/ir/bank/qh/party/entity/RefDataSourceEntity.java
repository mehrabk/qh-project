...
/**
 * منبع ایجاد یا راستی‌آزمایی اطلاعات.
 * Maps to table REF_DATA_SOURCE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_DATA_SOURCE")
@Getter
@Setter
public class RefDataSourceEntity extends BaseEntity {
