...
/**
 * منطقه یا ناحیه شهری نشانی.
 * Maps to table REF_DISTRICT.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_DISTRICT")
@Getter
@Setter
public class RefDistrictEntity extends BaseEntity {
    ...
    @JoinColumn(name = "CITY_CODE", referencedColumnName = "CITY_CODE", nullable = false,
            foreignKey = @ForeignKey(name = "REF_DISTRICT_FK_CITY"))
