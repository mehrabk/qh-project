...
/**
 * طبقه‌بندی اندازه شخص حقوقی.
 * Maps to table REF_ENTERPRISE_SIZE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_ENTERPRISE_SIZE")
@Getter
@Setter
public class RefEnterpriseSizeEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "ENTERPRISE_SIZE_CODE", length = 50)
