...
/**
 * نقش Party در یک گروه.
 * Maps to table REF_GROUP_MEMBER_ROLE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_GROUP_MEMBER_ROLE")
@Getter
@Setter
public class RefGroupMemberRoleEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "MEMBER_ROLE_CODE", length = 50)
