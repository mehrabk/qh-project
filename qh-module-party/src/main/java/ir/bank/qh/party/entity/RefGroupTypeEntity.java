...
/**
 * نوع گروه Party در یک صندوق.
 * Maps to table REF_GROUP_TYPE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_GROUP_TYPE")
@Getter
@Setter
public class RefGroupTypeEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "GROUP_TYPE_CODE", length = 50)
