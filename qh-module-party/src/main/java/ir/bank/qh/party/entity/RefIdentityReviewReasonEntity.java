...
/**
 * علت ایجاد درخواست بازبینی هویت مرکزی.
 * Maps to table REF_IDENTITY_REVIEW_REASON.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_IDENTITY_REVIEW_REASON")
@Getter
@Setter
public class RefIdentityReviewReasonEntity extends BaseEntity {
