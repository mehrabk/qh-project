...
/**
 * وضعیت چرخه بازبینی اختلاف هویتی در هسته مرکزی.
 * Maps to table REF_IDENTITY_REVIEW_STATUS.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_IDENTITY_REVIEW_STATUS")
@Getter
@Setter
public class RefIdentityReviewStatusEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "REVIEW_STATUS_CODE", length = 50)
