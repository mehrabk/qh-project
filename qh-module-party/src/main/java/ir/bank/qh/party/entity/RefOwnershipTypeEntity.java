...
/**
 * نوع مالکیت شخص حقوقی.
 * Maps to table REF_OWNERSHIP_TYPE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_OWNERSHIP_TYPE")
@Getter
@Setter
public class RefOwnershipTypeEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "OWNERSHIP_TYPE_CODE", length = 50)
