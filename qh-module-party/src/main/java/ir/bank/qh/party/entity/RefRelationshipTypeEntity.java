...
/**
 * نوع رابطه بین Party دارای نقش و Party اصلی در همان صندوق.
 * Maps to table REF_RELATIONSHIP_TYPE.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_RELATIONSHIP_TYPE")
@Getter
@Setter
public class RefRelationshipTypeEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "RELATIONSHIP_TYPE_CODE", length = 50)
