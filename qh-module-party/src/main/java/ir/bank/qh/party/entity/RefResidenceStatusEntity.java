...
/**
 * وضعیت اقامت شخص.
 * Maps to table REF_RESIDENCE_STATUS.
 */
@EqualsAndHashCode(callSuper = false, onlyExplicitlyIncluded = true)
@Entity
@Table(schema = "PARTY", name = "REF_RESIDENCE_STATUS")
@Getter
@Setter
public class RefResidenceStatusEntity extends BaseEntity {
    ...
    @Id
    @Column(name = "RESIDENCE_STATUS_CODE", length = 50)
