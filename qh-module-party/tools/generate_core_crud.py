...
OUT_ROOT = os.path.normpath(os.path.join(TOOLS_DIR, '..', 'core/src/main/java/ir/bank/qh/party/core'))
...
for entity_name, path in CORE:
    ...
    repo = f'''package ir.bank.qh.party.core.repository;

import ir.bank.qh.party.core.entity.{entity_name};
...
'''
    ...
    svc = f'''package ir.bank.qh.party.core.service;

import ir.bank.qh.party.core.entity.{entity_name};
import ir.bank.qh.party.core.repository.{repo_name};
...
'''
    ...
    ctrl = f'''package ir.bank.qh.party.core.controller;

import ir.bank.qh.party.core.entity.{entity_name};
import ir.bank.qh.party.core.service.{svc_name};
