...
OUT_ROOT = os.path.normpath(os.path.join(TOOLS_DIR, '..', 'reference/src/main/java/ir/bank/qh/party/reference'))
...
for table in ref_tables:
    ...
    # ---- Entity ----
    lines = []
    lines.append('package ir.bank.qh.party.reference.entity;')
    lines.append('')
    lines.append('import ir.bank.qh.common.entity.BaseEntity;')
    lines.append('import ir.bank.qh.party.reference.converter.YesNoConverter;')
    ...
    repo = f'''package ir.bank.qh.party.reference.repository;

import ir.bank.qh.party.reference.entity.{entity_name};
...
'''
    ...
    svc = f'''package ir.bank.qh.party.reference.service;

import ir.bank.qh.party.reference.entity.{entity_name};
import ir.bank.qh.party.reference.repository.{repo_name};
...
'''
    ...
    path = url_path(table)
    ctrl = f'''package ir.bank.qh.party.reference.controller;

import ir.bank.qh.party.reference.entity.{entity_name};
import ir.bank.qh.party.reference.service.{svc_name};
