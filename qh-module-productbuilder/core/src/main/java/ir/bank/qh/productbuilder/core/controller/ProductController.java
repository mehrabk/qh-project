...
public class ProductController {
    ...
    public ApiResponse<Product> create(@Valid @RequestBody Product entity) {
        return ApiResponse.ok(service.create(entity), "با موفقیت ایجاد شد");
    }

    @PutMapping("/{id}")
    public ApiResponse<Product> update(@PathVariable Long id, @Valid @RequestBody Product entity) {
