...
import ir.bank.qh.productbuilder.reference.repository.DocumentTypeRepository;
...
/**
 * Service for DocumentType. Business-rule checks equivalent to the
...
public class DocumentTypeService extends AbstractCrudService<DocumentType> {
    ...
    @Override
    protected JpaRepository<DocumentType, Long> repository() {
        return repository;
    }
