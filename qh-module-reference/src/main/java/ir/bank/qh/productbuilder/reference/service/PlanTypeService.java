...
import ir.bank.qh.productbuilder.reference.repository.PlanTypeRepository;
...
/**
 * Service for PlanType. Business-rule checks equivalent to the
...
public class PlanTypeService extends AbstractCrudService<PlanType> {

    private final PlanTypeRepository repository;

    @Override
    protected JpaRepository<PlanType, Long> repository() {
        return repository;
    }
